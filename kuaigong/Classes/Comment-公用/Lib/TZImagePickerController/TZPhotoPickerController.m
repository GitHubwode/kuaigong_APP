...
- (void)configBottomToolBar {
    ...
    [_previewButton setTitleColor:KGGTitleTextColor forState:UIControlStateNormal];
    ...
    if (tzImagePickerVc.allowPickingOriginalPhoto) {
        ...
        [_originalPhotoButton setTitleColor:KGGTitleTextColor forState:UIControlStateSelected];
        ...
        _originalPhotoLable.textColor = KGGTitleTextColor;
