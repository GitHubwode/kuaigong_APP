...
#define kTimeBroadcastViewHeight kScaleFrom_iPhone5_Desgin(264)
...
- (void)setTimeBroadcastView
{
    ...
    topView.backgroundColor = UIColorHex(0xf3f3f3);
    
    okBtn = [[UIButton alloc]initWithFrame:CGRectMake(kScreen_Width-60, 0, 60, kTopViewHeight)];
    [okBtn setTitleColor:KGGGoldenThemeColor forState:UIControlStateNormal];
    okBtn.titleLabel.font = KGGRegularFont(16);
    ...
    cancleBtn.titleLabel.font = KGGRegularFont(16);
    [cancleBtn setTitleColor:UIColorHex(0x9c9c9c) forState:UIControlStateNormal];
    ...
    timeBroadcastView = [[UIView alloc] initWithFrame:CGRectMake(0, -64, kScreen_Width, kTimeBroadcastViewHeight)];
...
//        [weak setBackgroundColor:[UIColor colorWithRed:0 green:0 blue:0 alpha:0.f]];
        weak.backgroundColor = KGGColorA(0, 0, 0, 75);
