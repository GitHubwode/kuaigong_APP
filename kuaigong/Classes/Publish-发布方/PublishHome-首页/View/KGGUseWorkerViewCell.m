...
static NSString *KGGUseWorkerInfoCellIdfy = @"KGGUseWorkerInfoCellIdfy";

@interface KGGUseWorkerViewCell ()<UITextFieldDelegate>
...
@implementation KGGUseWorkerViewCell
...
- (void)kgg_UserName:(NSString *)name
{
    ...
    self.infoItem.subtitle =name;
    
}
- (void)kgg_UserTel:(NSString *)tel
{
    self.textField.text = tel;
    self.infoItem.subtitle =tel;
}
- (void)kgg_userAddress:(NSString *)address
{
    ...
    self.infoItem.subtitle = address;
}

+ (NSString *)cellIdentifier
{
    return KGGUseWorkerInfoCellIdfy;
}
